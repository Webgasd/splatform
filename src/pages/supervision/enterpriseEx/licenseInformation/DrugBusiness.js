...
class DrugBusiness extends Component{
    ...
    changeStartTime=(value,option,index)=>{
        let drugsBusinessList = this.props.input.drugsBusinessList||[];
        drugsBusinessList[index][option]=value;
        drugsBusinessList[index].giveTime=value;
        drugsBusinessList[index].endTime=moment(value).add(5,'years').subtract(1,'day')
    ...
    render() {
        ...
        const drugsBusinessList = this.props.input.drugsBusinessList||[]
        const index =this.props.index
        const formData =drugsBusinessList[index]||{}
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td> <Select placeholder={"请选择经营方式"} value={formData.operationMode} style={{width:"100%"}}onChange={(value)=>this.changeInput(value,"operationMode",index)} disabled={checkStatus}>
