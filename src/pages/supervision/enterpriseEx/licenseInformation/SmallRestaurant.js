...
class SmallRestaurant extends Component{
    ...
    changeStartTime=(value,option,index)=>{
        let smallCaterList = this.props.input.smallCaterList||[];
        smallCaterList[index][option]=value;
        smallCaterList[index].giveTime=value;
        smallCaterList[index].endTime=moment(value).add(3,'years').subtract(1,'day')
    ...
    render() {
        ...
        const smallCaterList = this.props.input.smallCaterList||[]
        const index =this.props.index
        const formData =smallCaterList[index]||{}
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>主体类别</td>
                        <td> <Select placeholder={"请选择类别"} value={formData.mainCategory} style={{width:"100%"}}onChange={(value)=>this.changeInput(value,"mainCategory",index)} disabled={checkStatus}>
            ...
            {/* 检查及评定 */}
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td style={{width:'10%'}}><img src={require("./imgs/小餐饮.png")} style={{height:'8%'}} alt=""/> </td>
                        <td style={{textAlign:"left"}}><Checkbox value={"小餐饮"} >小餐饮</Checkbox> </td>

                        <td style={{width:'10%'}}><img src={require("./imgs/u823.png")} style={{height:'8%'}} alt=""/></td>
                        <td style={{textAlign:"left"}}><Checkbox value={"餐饮服务"} >餐饮服务</Checkbox></td>
                    </tr>
                    </tbody>
                    </Checkbox.Group>
                </table>
