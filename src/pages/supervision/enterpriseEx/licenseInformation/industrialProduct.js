...
class IndustrialProduct extends Component{
    ...
    changeStartTime=(value,option,index)=>{
        let industrialProductsList = this.props.input.industrialProductsList||[];
        industrialProductsList[index][option]=value;
        industrialProductsList[index].giveTime=value;
        industrialProductsList[index].endTime=moment(value).add(5,'years').subtract(1,'day')
    ...
    render() {
        ...
        const industrialProductsList = this.props.input.industrialProductsList||[]
        const index =this.props.index
        const formData =industrialProductsList[index]||{}
            ...
            {/* 检查及评定 */}
                ...
                <tbody>
                    <tr>
                        ...
                        <td style={{width:'3%'}}><img src={require("./imgs/工业产品.png")} style={{height:'8%'}} alt=""/></td>
                        <td style={{width:'30%'}}><Checkbox.Group style={{width:'100%',textAlign:"left"}} value={formData.checkType?formData.checkType.split(','):[]}
                            onChange={(value)=>this.onCheckChange(value,'checkType',index)} disabled={checkStatus}>
                                ...
                                <Checkbox style={{marginLeft:5}} value={'工业产品'}>工业产品</Checkbox>
