...
class FoodProduction extends Component{
   ...
   state={categoryList:[],licenceList:[]}
    ...
    changeInput=(value,option)=>{
        let FoodProduction = this.props.input.FoodProduction||{};
        FoodProduction[option]=value;
        let input = {...this.props.input,FoodProduction}
    ...
    render() {
        ...
        return (
            ...
            <div className='commonEnterpriseBox' style={{marginTop:20}}>
                <div className='permission-title-text'>检查及评定</div>
                <table>
                    <tbody>
                    <tr>
