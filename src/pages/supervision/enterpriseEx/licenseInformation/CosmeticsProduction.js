...
class CosmeticsProduction extends Component{
    ...
    changeStartTime=(value,option,index)=>{
        let cosmeticsList = this.props.input.cosmeticsList||[];
        cosmeticsList[index][option]=value;
        cosmeticsList[index].giveTime=value;
        cosmeticsList[index].endTime=moment(value).add(5,'years').subtract(1,'day')
    ...
    render() {
        ...
        const cosmeticsList = this.props.input.cosmeticsList||[]
        const index =this.props.index
        const formData =cosmeticsList[index]||{}
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><Input value={formData.registerCode} onChange={(e)=>this.changeInput(e.target.value,"registerCode",index)} placeholder={"请输入证号"} disabled={checkStatus}/></td>
                        <td>质量负责人</td>
            ...
            {/* 检查及评定 */}
                ...
                <tbody>
                    <tr>
                        ...
                        <td style={{width:'3%'}}><img src={require("./imgs/化妆品生产.png")} style={{height:'8%'}} alt=""/></td>
                        <td style={{width:'30%'}}><Checkbox.Group style={{width:'100%',textAlign:"left"}} value={formData.checkType?formData.checkType.split(','):[]}
                            onChange={(value)=>this.onCheckChange(value,'checkType',index)} disabled={checkStatus}>
                                ...
                                <Checkbox style={{marginLeft:5}} value={'化妆品生产'}>化妆品生产</Checkbox>
...
export default CosmeticsProduction;
