...
import {Form, Select, Input, Row, Col, Radio, DatePicker, Icon, Modal, Button, Upload} from 'antd'
                    ...
                    <div className="row-my deal-result" style={{width:"100%"}}>
                        <Form.Item
                            ...
                            label={<div style={{height:"100%"}}><p style={{display:"inline-block"}}>办理结果</p><span style={{verticalAlign:"middle",height:"100%",display:"inline-block"}}></span></div>}>
                             ...
                             <TextArea autosize={{minRows:4,maxRows:10}} className="textarea-my-1"/>)}
                        </Form.Item>
                </div>:null
                }
                </React.Fragment>
    ...
    render(){
        ...
        <div className="form-detail-wrap">
            <Form layout="inline" labelAlign="left">
                <div className="row-my" style={{width:"70%"}}>
                        <Form.Item
                        colon={false}
                            style={{width:"100%",margin:0}}
                            label="标题">
                                {getFieldDecorator('title', {
                                    initialValue: nowDealRecord.title,
                                })(<Input disabled={action!=="add"} className="input-my-4" placeholder="请输入标题"/>)}
                        </Form.Item>
                </div>
                {/*<div  style={{width:"30%"}}>*/}
                    {/*<Form.Item*/}
