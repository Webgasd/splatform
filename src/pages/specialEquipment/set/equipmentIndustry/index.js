...
class EquipmentIndustry extends Component{
    state={
    ...
    requestList = ()=>{
        let _this = this;
        axios.ajax({
            url:'/specialEquipmentIndustry/getPage',
            data:{
                params:this.params
            }
        }).then((res)=>{
    ...
    handleSubmit = ()=>{
        ...
        axios.ajax({
            url:type=='create'?'/specialEquipmentIndustry/insert':'/specialEquipmentIndustry/update',
            data:{
                params:{
                    ...data
                }
    ...
    handleOperator = (type,item)=>{
        if(type =='create'){
            ...
            Modal.confirm({
                ...
                onOk:()=>{
                    axios.ajax({
                        url:'/specialEquipmentIndustry/delete',
                        data: {
                            params: {
                                id: item.id
                            }
...
export default EquipmentIndustry;