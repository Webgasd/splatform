...
class EquipmentTypeThree extends React.Component{
    constructor(props){
        super(props)
        this.state={
            list:[],
    ...
    requestList = ()=>{
        let _this = this;
        axios.ajax({
            url:"/specialEquipmentType/getPageThree",
            data:{
                params:this.params
            }
        }).then((res)=>{
    ...
    handleOk=()=>{
        axios.ajax({
            url:"/specialEquipmentType/insertThree",
            data:{
                params:{
    ...
    showModalDelete=(id)=>{
        axios.ajax({
            url:"/specialEquipmentType/deleteThree",
            data:{
                params:{
                    id
                }
    ...
    handleEdit=()=>{
        ...
        axios.ajax({
            url:"/specialEquipmentType/updateThree",
            data:{
                params:{
                    parentName,
                    name:inputValue,
...
export default EquipmentTypeThree
