...
import EmployeeList from './enterpriseWorkerList'
import EnterpriseRecords from './enterpriseRecord'
...
@connect(
 ...
 class LiveVideo extends Component{
     state={
        ...
        id:0,
        cutUrl: this.props.videoInfo.type == '海康'?`rtmp://${this.props.videoInfo.rtmpIp}:${this.props.videoInfo.rtmpPort}/live/pag/${this.props.videoInfo.vagIp}/${this.props.videoInfo.vagPort}/${this.props.videoInfo.list[0].number}/0/MAIN/TCP`:
            ...
            <div className= {'videoCSS'}>
                            ...
                            <table>
                                <tbody>
                                    {list.map((item,index)=>(
                                        <tr>
                                            <td style={{width:119}}>
                                                <Button style={{width:119,backgroundColor:"#F2F2F2"}} onClick={()=>{this.setUrl(item.number,item.channelNumber,item.byteType)}} icon="desktop">{item.position}</Button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
                ...
                <Col span={3}>
                            <div>
                                ...
                                onClick={()=>this.handleQuestion()}>常见问题</Button>
