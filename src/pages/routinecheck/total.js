        ...
        axios.ajax({
            ...
            if(res.status == 'success'){
               ...
               let checkEnterpriseA = res.data.areaList.map((item) => {
                ...
                res.data.areaCount[item.id].foodCirculate.checkEnterprise+
                res.data.areaCount[item.id].foodProduce.checkEnterprise
              ...
              let checkEnterprise = sumc;
               //let checkEnterprise = res.data.enterpriseMarkA+res.data.enterpriseMarkB+res.data.enterpriseMarkC+res.data.enterpriseMarkD;
                ...
                let enterpriseMarkA = res.data.enterpriseMarkA.foodCommon +
                 res.data.enterpriseMarkA.foodCirculate +
                 res.data.enterpriseMarkA.foodProduce;
                let enterpriseMarkB = res.data.enterpriseMarkB.foodCommon +
                res.data.enterpriseMarkB.foodCirculate +
                res.data.enterpriseMarkB.foodProduce;
                let enterpriseMarkC = res.data.enterpriseMarkC.foodCommon +
                res.data.enterpriseMarkC.foodCirculate +
                res.data.enterpriseMarkC.foodProduce;
                let enterpriseMarkD = res.data.enterpriseMarkD.foodCommon +
                res.data.enterpriseMarkD.foodCirculate +
                res.data.enterpriseMarkD.foodProduce;
                let enterpriseMarkN = res.data.enterpriseMarkN.foodCommon +
                res.data.enterpriseMarkN.foodCirculate +
                res.data.enterpriseMarkN.foodProduce;
                ...
                let enterpriseData = checkEnterprise /enterpriseNumber1;
