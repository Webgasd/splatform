        ...
        axios.ajax({
            ...
            if(res.status == 'success'){
                let enterpriseNumberA = res.data.areaList.map((item) => {
                    return res.data.areaCount[item.id].foodProduce.numberEnterprise 
                ...
                let checkEnterpriseA = res.data.areaList.map((item) => {
                    return res.data.areaCount[item.id].foodProduce.checkEnterprise 
                ...
                let haveCheckT1 = res.data.areaList.map((item) => {
                    return res.data.areaCount[item.id].foodProduce.haveCheck 
                ...
                let shouldCheckT1 = res.data.areaList.map((item) => {
                    return res.data.areaCount[item.id].foodProduce.shouldCheck 
