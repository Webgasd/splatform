        ...
        axios.ajax({
            ...
            if(res.status == 'success'){
                let enterpriseNumberA = res.data.areaList.map((item) => {
                    return res.data.areaCount[item.id].foodCirculate.numberEnterprise 
                ...
                let checkEnterpriseA = res.data.areaList.map((item) => {
                    return res.data.areaCount[item.id].foodCirculate.checkEnterprise 
                ...
                let haveCheckT1 = res.data.areaList.map((item) => {
                    return res.data.areaCount[item.id].foodCirculate.haveCheck 
                ...
                let shouldCheckT1 = res.data.areaList.map((item) => {
                    return res.data.areaCount[item.id].foodCirculate.shouldCheck 
                    ...
                    <Dcircle
                        ...
                        checkData={this.state.checkData}
                          ...
                          <Everylink
                           ...
                           //shouldCheckT={this.state.shouldCheckT}
