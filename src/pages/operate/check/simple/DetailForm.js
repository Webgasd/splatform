...
import ListForm from "./../../on_record/simple/ListForm";
                ...
                <Card>
                    <div className='commonEnterpriseBox'>
                        <table>
                            <tbody>
                            <tr>
                                <td style={{background:'#F2F2F2',width:40}}>就餐类型</td>
                                <td style={{width:120}}><Input value={formData.type} disabled={type=='detail'?true:false} onChange={(e)=>this.changeInput(e.target.value,'type')}/></td>
                                <td style={{background:'#F2F2F2',width:40}}>就餐日期</td>
                                <td style={{width:120}}>
                                ...
                                <td style={{background:'#F2F2F2',width:40}}>餐次</td>
                                <td style={{width:80}}>
                            ...
                            <tr>
                                <td style={{background:'#F2F2F2',width:40}}>事项</td>
                                <td style={{width:120}}><Input value={formData.matter} disabled={type=='detail'?true:false} onChange={(e)=>this.changeInput(e.target.value,'matter')}/></td>
                                <td style={{background:'#F2F2F2',width:40}}>就餐人数</td>
                                <td style={{width:120}}><Input value={formData.number} disabled={type=='detail'?true:false} onChange={(e)=>this.changeInput(e.target.value,'number')}/></td>
                            </tr>
                            </tbody>
                        </table>
                        <Form layout="inline">
