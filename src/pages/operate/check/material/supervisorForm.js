...
export default class SupervisorForm extends Component{
    ...
    requestList = ()=>{
      ...
      //  console.log(this.props.sup);
        ...
        axios.PostAjax({
            url:this.props.personType=='originName'?'/formatoriginextra/getPage':(this.props.personType=='person'?'/supervision/ca/getPageAll':(this.props.personType=='goodsInType'?'/formatmeasurement/getPage':'/formatsupplier/getPage')),
            data:{               
                params:{
    ...
    handleOperator=(item)=>{
        ...
        else if(this.props.personType=='person'){
            ...
            <div>
                ...
                <Card style={{marginTop:10}}>
                    <Table
                        ...
                        columns={this.props.personType=='person'?columns1:(this.props.personType=='originName'?columns:(this.props.personType=='supplier'?columns2:(this.props.personType=='goodsInType'?columns4:columns3)))}
                    />
                </Card>
            </div>
        );
