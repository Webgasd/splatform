...
import {Card, Input, Button, Icon, Select, Upload, DatePicker, message, Modal, Table} from "antd";
                    ...
                    <div className='commonEnterpriseBox'>
                        <table>
                            ...
                            {/*<tr>*/}
                                ...
                                {/*<td style={{width:'29%'}}><Input value={formData.enterpriseName} disabled={type=='detail'?true:false}/></td>*/}
                                {/*<td style={{background:'#F2F2F2'}}>所属区域:</td>*/}
                                {/*<td style={{width:'50%'}}><Input value={formData.areaName} disabled={type=='detail'?true:false}/></td>*/}
                            {/*</tr>*/}
                            <tr>
