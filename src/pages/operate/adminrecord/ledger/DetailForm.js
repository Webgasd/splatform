...
import {Card,Input,DatePicker,Select,Form,message,Upload,Button,Icon,Modal,Table} from "antd";
                ...
                <Card  style={{marginLeft:15,marginRight:15}}>
                    ...
                    <tr>
                            ...
                            {formData.areaName}
                                ...
                                {/* <Input value={formData.enterpriseName} disabled={type=='detail'?true:false}/> */}                  
                                {/* <Input value={formData.areaName} style={{marginTop:10}} disabled={type=='detail'?true:false}/> */}
                        </tr>
               <tr>
                  <FormItem  label="类型" >
                      {
