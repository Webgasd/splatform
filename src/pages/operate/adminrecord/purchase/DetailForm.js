...
import {Card, Input, Button, Radio, DatePicker, Icon, Upload, message, Select, Modal, Row, Col, Table} from "antd";
import {connect} from 'react-redux'
import {changePurchase} from "../../../../redux/action";
...
class DetailForm extends Component{
    ...
    changeInput=(value,option)=>{
        ...
        this.props.changePurchase(input);
    }
    handleFile = (info) => {
        ...
        return(
            <div className='commonEnterpriseBox'>
                <table>
                    <tbody>
                    <tr>
                        <td style={{background:'#F2F2F2',width:'15%'}}>所在企业</td>
                        <td colSpan={3}><Input value={formData.enterpriseName} disabled={type=='detail'?true:false}/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style={{background:'#F2F2F2',width:'15%'}}>进货日期<span style={{color:'#FF3300'}}>*</span></td>
                        <td>
                            <DatePicker style={{width:'100%'}}
                                        disabled={type=='detail'?true:false}
                    ...
                    <tr>
                        <td style={{background:'#F2F2F2',width:'15%'}}>进货数量<span style={{color:'#FF3300'}}>*</span></td>
                        <td>
                            <Row>
