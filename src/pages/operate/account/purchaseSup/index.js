...
import {changePurchase, clearPurchase} from '../../../../redux/action';
...
class Purchase extends Component{
    ...
    handleOperator = (type,item)=>{
        if(type =='create'){
            ...
            this.props.changePurchase({...item,document:JSON.parse(item.document||JSON.stringify([]))});
        }else if(type=="delete"){
            Modal.confirm({
                content:'确定要删除此用户吗？',
                onOk:()=>{
        ...
        const columns = [
            {
                ...
                render:(text,item)=>{
                    return <Row>
                        <Col span={8}><div className="textButton" onClick={()=>{this.handleOperator('detail',item)}}>查看</div></Col>
                        {/*<Col span={8}><div className="textButton" onClick={()=>{this.handleOperator('edit',item)}}>修改</div></Col>*/}
                        {/*<Col span={8}><div className="textButton" onClick={()=>{this.handleOperator('delete',item)}}>删除</div></Col>*/}
            ...
            <div ref="purchase">
                ...
                <Card style={{marginTop:10}}>
                    <div className='button-box'>
                        ...
                        {/*<Upload action={commonUrl+"/formatgoods/importExcelIn"}*/}
                            ...
                            {/*<Button type="primary" onClick={()=>window.open(commonUrl+'/upload/downloadFile?name=进货导入模板.xls')}>导入模板</Button>*/}
                        {/*</Upload>*/}
                ...
                <Modal {...footer}
                    width='800px'
                    maskClosable={false}
                    getContainer={()=>this.refs.purchase}
