...
class DetailForm extends Component{
    ...
    render() {
        ...
        console.log(formData.checkCompany)
            ...
            <div className='commonEnterpriseBox'>
                <table>
                    ...
                    <tr>
                        ...
                        <td colSpan={3}><Input value={formData.checkCompany} onClick={()=>this.setState({iscVisible:true,searchType:'checkCompany',teamType:'team'})} placeholder={"请选择被抽检单位"} disabled={type=='detail'?true:false} suffix={<Icon type="search" />} onChange={(e)=>this.changeInput(e.target.value,'checkCompany')}/></td>
                    ...
                    <tr>
                        ...
                        <td><Input value={formData.checkOrginization} disabled={true}/></td>
                    ...
                    <tr>
                        ...
                        <td colSpan={3}><Input value={formData.team} disabled={type=='detail'?true:false} onChange={(e)=>this.changeInput(e.target.value,'team')}/></td>
                ...
                >
                    <TypeForm dispatchSupervisor={(data1,data2)=>{
                        console.log(data1)
                        console.log(data2)
                        console.log(this.state.searchType)
                        console.log(this.state.teamType)
                        this.setState({iscVisible:false})
                        // this.changeInput(data1,this.state.searchType);
                        // this.changeInput(data2,this.state.teamType);
                        this.changeDoubleInput(data1,this.state.searchType,data2,this.state.teamType)
                    }}
                              searchType={this.state.searchType}
                    />
                </Modal>
