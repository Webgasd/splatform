...
class Additive extends Component{
    ...
    requestList = ()=>{
        ...
        axios.ajax({
            url:'/quickCheckProductType/getPage',
            data:{
                params:this.params
            }
        }).then((res)=>{
    ...
    handleSubmit = ()=>{
        ...
        axios.ajax({      
            url:type=='create'?'/quickCheckProductType/insert':'/quickCheckProductType/update',
            data:{               
                params:{
                    ...data
                }          
    ...
    handleOperator = (type,item)=>{
        if(type =='create'){
            ...
            Modal.confirm({
                ...
                onOk:()=>{
                    axios.ajax({
                        url:'/quickCheckProductType/delete',
                        data: {
                            params: {
                                id: item.id
                            }
        ...
        return (
            <div ref="qcproduct">                
                ...
                <Modal
                    ...
                    maskClosable={false}
                    getContainer={()=>this.refs.qcproduct}
                    onCancel={()=>{
                        this.detailForm.props.form.resetFields();
                        this.setState({
                            isVisible:false,
