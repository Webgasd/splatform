...
export default class SupervisorForm extends Component{
    ...
    requestList = ()=>{
        let _this = this;
        axios.ajax({
            url:this.props.personType=='checkResult'?'/quickSpotCheckResultType/getPage':(this.props.personType=='market'?'/quickCheckEnterprise/getPageOk':'/quickCheckProductType/getPage'),
            data:{
                params:{
                    ..._this.params
                }
            ...
            <div>
                <Card style={{marginTop:10}}>
                    <Table
                        ...
                        columns={this.props.personType=='market'?columns1:columns}
                    />
                </Card>
            </div>
        );
